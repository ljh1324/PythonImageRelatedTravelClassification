...
def expandImageTest(filename, saveFileName, imgSize):
  img = load_img(filename, target_size=imgSize)  # this is a PIL image
...
if __name__ == '__main__':
  ...
  expandImageTest('paper.jpg', 'paper_resize.jpg', (256, 256))