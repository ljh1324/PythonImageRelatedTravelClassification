...
def loadAllDataAndSaveNumpy(rootfolder, imgSize, labelSize, labelMapper, labelLength):
  """
  Path 읽기
  0_안녕하세요, 1_바다 ... 안의 각 샘플 폴더 모두 취합
    샘플 폴더 e.g. 1_바다/../2018-05-22_230321_kyg
  ...
  np.save('./numpyExpandData/trainImageList.npy', trainImageList) # 영어 데이터 + 한글 데이터 저장폴더
  np.save('./numpyExpandData/trainLabelList.npy', trainLabelList)
  np.save('./numpyExpandData/testImageList.npy', testImageList)
  np.save('./numpyExpandData/testLabelList.npy', testLabelList)
